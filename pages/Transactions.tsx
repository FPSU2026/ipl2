...
const Transactions: React.FC = () => {
  ...
  const currentCashBalance = useMemo(() => {
      ...
      // Filter all cash transactions excluding 'Saldo Awal' (to avoid double counting base)
              ...
              <div className="bg-white rounded-[2.5rem] shadow-2xl max-w-sm w-full overflow-hidden animate-in zoom-in duration-200 flex flex-col max-h-[80vh]">
                  ...
                  <div className="p-6 bg-slate-50 border-t border-slate-100 shrink-0">
                      <div className="flex justify-between items-center">
                          ...
                          <span className={`text-xl font-black ${detailType === 'INITIAL' ? 'text-indigo-600' : detailType === 'INCOME' ? 'text-emerald-600' : 'text-rose-600'}`}>
